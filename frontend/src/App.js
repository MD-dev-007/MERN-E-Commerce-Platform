      ...
      <>
...

        {
          loggedInUser?.isAdmin?(
            ...
            <Route path='/admin/create-auction' element={<Protected><CreateAuctionPage/></Protected>}/>
            ...
            <Route path='/auctions' element={<Protected><AuctionsPage/></Protected>}/>
            <Route path='/auctions/:id' element={<Protected><AuctionDetailsPage/></Protected>}/>
            </>
          )
        }
