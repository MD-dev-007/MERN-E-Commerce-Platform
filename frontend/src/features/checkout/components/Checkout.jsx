...
export const Checkout = () => {
    ...
    const handleCreateOrder = async () => {
        if (selectedPaymentMethod === 'CARD') {
            try {
                const { data } = await axiosi.post('/payment/create-order', { 
                ...
                const options = {
                    ...
                    handler: async (response) => {
                        try {
                            const { data: verifyData } = await axiosi.post('/payment/verify', response);
            ...
            // For cash payment, directly create order
            const order = {
                user: loggedInUser._id,
                item: cartItems,
                address: selectedAddress,
